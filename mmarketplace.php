...
<div class="container">
    ...
    <div class="middle-section">
        ...
        <button class="nav-button" onclick="nav_logout()">···</button>
            ...
            <a href="mmarketplace.php" class="headtitle-order underline ">
                <p style="color: #994700;">My Products</p>
            </a>
            <a href="profile.php" class="headtitle-middle ">
             <p>My Profile</p>
            </a>
    ...
    <div id='product'>
        ...
        <?php include 'backend/fetchmyproducts.php'; ?>
    </div>
</div>
</div>
...
<script src="js/mmarketplace.js"></script>
</body>
